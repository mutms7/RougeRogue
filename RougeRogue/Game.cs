...
namespace RougeRogue
{
    public static class Game
    {
        ...
        public static void Main()
        {
            ...
            MapGenerator mapGenerator = new MapGenerator(_mapWidth, _mapHeight, 15, 13, 7, _mapLevel);
            ...
            if (CommandSystem.IsPlayerTurn)
            {
                if (keyPress != null)
                {
                    ...
                    else if (keyPress.Key == RLKey.Period)
                    {
                        ...
                        {
                            MapGenerator mapGenerator = new MapGenerator(_mapWidth, _mapHeight, 15, 13+2*_mapLevel, 10+2 * _mapLevel, ++_mapLevel);
                            DungeonMap = mapGenerator.CreateMap();
                            MessageLog = new MessageLog();
                            CommandSystem = new CommandSystem();
